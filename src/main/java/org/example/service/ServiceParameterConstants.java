...
public class ServiceParameterConstants {

    public static Integer TOTAL_PLAYER_COUNT=18;
    public static  Integer GK_COUNT=2;
    ...
    public static  Integer ML_COUNT=2;
    public static  Integer ST_COUNT=3;
